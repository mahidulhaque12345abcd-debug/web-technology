...
form.html push.php script.js style.css view.php demo_site.sql Move Files to the XAMPP Directory Place the four web files (form.html, push.php, script.js, and style.css) into a new folder named as try. Move this folder to the following location: -> makefile -> Copy -> paste -> C:\xampp\htdocs
...
To view the project in a web browser Go to: **http://127.0.0.1/try/form.html ** Replace folder_name with the name of the folder you created in C:\xampp\htdocs.
